...
const orderedStudies = [
  ...
  /* ── 06 · DELTA COMPANY ── */
  {
    ...
    blocks: [
      ...
      { type: 'filmstrip', contain: true, items: [
        ...
        { src: P('ubisoft-delta/fans/EDe8lJCWkAAY0Eh.jpg'), cap: 'Members in their Delta tees, out in the community.' },
      ...
      { type: 'filmstrip', contain: true, items: [
        { src: P('ubisoft-delta/fans/image0.jpg'), cap: 'Delta members in the wild. The program in person, at the booth.' },
        { src: P('ubisoft-delta/fans/EIeDXghX0AEY945.jpg'), cap: 'Cosplay as photography. Shot by member Mademoiselle Bellec.' },
        { src: P('ubisoft-delta/fans/EJBtWpTXYAAmlI3.jpg'), cap: 'Fan art. “Brother vs Brother”, made by a member.' },
        { src: P('ubisoft-delta/fans/EJfvV_AU8AIAsfF.jpg'), cap: 'Fan video, by member channel NGN.' },
        { src: P('ubisoft-delta/fans/EHeMce6XkAAJuLI.jpg'), cap: 'A cosplay action shot, staged by members.' },
      ] },
  ...
  /* ── 07 · BLABLACAR ── */
  {
    id: 'blablacar', name: 'BlaBlaCar', skin: 'light', accent: '#B5740E',
    hero: {
      meta: 'BlaBlaCar · UK · 2013–2016',
      eyebrow: 'Case study · Partnerships',
      title: 'BlaBlaCar × Live Nation.',
      lede: 'Live Nation’s first ever Official Ridesharing Partner. Priority parking, on-site festival activation, bringing BlaBlaCar to festivals and helping people get home. Latitude, Leeds and Reading.',
      img: P('blablacar/blablacar-covoiturage-festival-banner.webp'),
    },
    blocks: [
      { type: 'statement', text: 'BlaBlaCar had a working app. What it needed in the UK was the cultural backdrop where ridesharing with strangers felt normal.' },
      { type: 'stats', items: [
        { value: '1st', label: 'Official Ridesharing Partner of Live Nation, UK' },
        { value: '2,200+', label: 'Rides offered via the partnership' },
        { value: '50%+', label: 'Wouldn’t have rideshared without the partnership' },
        { value: '20', label: 'Team members managed on-site' },
      ] },
      { type: 'section', kicker: '[01] · The opportunity', title: 'Festivals as a trust channel.',
        body: ['UK festivals are a cultural mass-moment: tens of thousands of people, all solving the same logistics problem. The offer was practical: carpool to the festival, and your parking was right at the entrance. Small wins, stacked.'] },
      { type: 'band', src: P('blablacar/blablacar-tent.png'),
        caption: 'The BlaBla Tent at Latitude, Leeds and Reading. Branded inflatable dome, flags, deckchairs, the Mini photobooth, the lot.' },
      { type: 'section', kicker: '[02] · The deal', title: 'First-of-its-kind in the UK.',
        body: [
          'BlaBlaCar became the UK’s first Official Ridesharing Partner of Live Nation, unprecedented for a carpooling platform. The partnership covered Latitude, Leeds and Reading.',
          'What we got: festival website presence, social cross-promotion, newsletter mentions, an exclusive priority-parking zone, and an on-site tent at each festival. Negotiated and delivered.',
        ] },
      { type: 'intro', eyebrow: 'Live Nation promoting BlaBlaCar on their own channels', title: 'The partnership, in receipts.' },
      { type: 'filmstrip', contain: true, items: [
        { src: P('blablacar/blablacar-tweet-reading.png'), cap: '@OfficialRandL: “Driving to Leeds Festival? Offer your ride on #BlaBlaCar and get FREE PRIORITY PARKING!”' },
        { src: P('blablacar/blablacar-tweet-latitude.png'), cap: '@LatitudeFest ran the same playbook. Same offer, same hook.' },
      ] },
      { type: 'section', kicker: '[03] · The activation', title: 'Branded parking, a tent, and people.',
        body: [
          'I designed and ran the on-site presence end-to-end, managing a team of 20 on the ground across three festivals. 300-space priority-parking zones at each festival, BlaBla Tents, a photobooth built into a functioning Mini, and a low-tech offline ride-matching board that paired 150+ post-its.',
          'To sweeten it, every member who used the priority parking was entered into a draw, one winner took home two weekend tickets to the next festival.',
          'Aggregate footprint: 2,200+ rides offered, 530+ cars in our priority lots, 3,000+ branded backpacks in attendees’ hands.',
        ] },
      { type: 'band', contain: true, src: P('blablacar/blablacar-ticket-winner.jpeg'),
        caption: 'A winner in the lot. Two weekend tickets to the next Latitude, drawn from everyone who used the priority parking.' },
      { type: 'intro', eyebrow: 'On the ground', title: 'The activation, in pictures.' },
      { type: 'filmstrip', contain: true, items: [
        { src: P('blablacar/laura-tent-team-police.jpg'), cap: 'Running the team at Leeds. Police joined in for the fun.' },
        { src: P('blablacar/blablacar-ride-board-closeup.png'), cap: 'Members in the funnel. ~150 post-its across the three festivals.' },
        ...
        { src: P('blablacar/blablacar-parking-pass.png'), cap: 'The pass in use. 305 priority-parking passes sent to UK members, for Latitude alone.' },
        { src: P('blablacar/blablacar-photobooth-strip.png'), cap: 'The Mini photobooth output. Branded, shareable, theirs to keep.' },
      ] },
      ...
      { type: 'section', divider: true, kicker: '[04] · The outcome', title: 'Carpooling, made normal.',
        body: ['The partnership wasn’t the only thing that took BlaBlaCar from 0 to 1M UK members, but it was the moment carpooling started to feel culturally normal here. The festival presence turned “is this safe?” into “how do I get a lift to next year’s Reading?”'] },
      { type: 'takeaway', kicker: '[05] · The takeaway', title: 'Trust as a channel.',
        lede: 'I turned festivals into a trust-building channel that made carpooling feel culturally normal in the UK. Driving growth, one new fan at a time.',
        principles: [
          { num: '01', head: 'Sponsor trust, don’t buy it.', body: 'Live Nation’s brand authority transferred to BlaBlaCar through the partnership. Worth more than fighting to earn it through paid media.' },
          { num: '02', head: 'Solve the logistics, win the brand moment.', body: 'Festival-goers had a real travel problem. BlaBlaCar became the answer, embedded in the cultural moment they were already invested in.' },
          { num: '03', head: 'Build community on the ground.', body: 'Branded parking, the tent, the team. The brand became tangible at the moment of need. Digital can’t replicate that.' },
        ] },
      { type: 'cta' },
    ],
  },
