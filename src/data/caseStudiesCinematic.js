...
const orderedStudies = [
  ...
  /* ── 07 · BLABLACAR ── */
  {
    ...
    blocks: [
      ...
      { type: 'video', src: P('blablacar/blablacar-route-ad-lille.mp4'), poster: P('blablacar/blablacar-route-ad-lille-poster.jpg'), aspect: '1612 / 400',
        caption: 'The system in one asset: real carpoolers, the seats filling, the price dropping, then the route. The story sells the ride.' },
      { type: 'video', src: P('blablacar/blablacar-storytelling-ad.mp4'), poster: P('blablacar/blablacar-storytelling-ad-poster.jpg'), aspect: '1600 / 400',
        caption: 'Same system, another route. One consistent brand, told the same way in every market.' },
      { type: 'quote',
