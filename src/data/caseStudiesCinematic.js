...
const orderedStudies = [
  ...
  /* ── 07 · BLABLACAR ── */
  {
    ...
    hero: {
      ...
      lede: 'Where I learned storytelling, and turned it into growth. I helped launch the UK from zero, brought the brand to the country’s biggest festivals, then built the first-person storytelling system that carried one brand across 22 markets, at a €5 CAC.',
    ...
    blocks: [
      ...
      { type: 'section', kicker: '[02] · The UK, from zero', title: 'Making carpooling part of the culture.',
        body: [
          ...
          'I brought BlaBlaCar to the UK’s biggest festivals, Latitude, Leeds and Reading, in partnership with Live Nation, making BlaBlaCar their first ever Official Ridesharing Partner. I designed and ran the on-site presence end to end, managing a team of 20 across the three festivals: 300-space priority-parking zones, the BlaBla Tents, a photobooth built into a functioning Mini, and a live ride board that paired 150+ post-its.',
