...
const ROUTE = {
  ...
  'blablacar': '/work/blablacar-storytelling',
}
...
const orderedStudies = [
  /* ── 01 · US MOBILE · DARK STAR ── */
  {
    ...
    blocks: [
      ...
      { type: 'carousel', aspect: '1/1', itemW: 'min(78vw,560px)', contain: true, items: [
        { src: P('us-mobile/us-mobile-vip-bundle.png'), alt: 'US Mobile Dark Star VIP Early Access Bundle: SIM kit and North Face fleece packshot', cap: 'The $129 Dark Star VIP Bundle, capped at 250 units.' },
      ...
      { type: 'splitmedia', vcenter: true, framed: true,
        ...
        images: [{ src: P('us-mobile/us-mobile-darkstar-email-copy.png'), alt: 'Dark Star launch email as sent to the US Mobile list' }],
  ...
  /* ── 03 · AZARUS · STREAMERS ── */
  {
    ...
    blocks: [
      ...
      { type: 'splitmedia', divider: true, kicker: '[02] · Campaign 1: the LoL launch', title: 'A coordinated US push for League of Legends.',
        ...
        images: [{ src: P('azarus/azarus-league-of-legends-banner.webp'), alt: 'Azarus League of Legends campaign banner' }],
      ...
      { type: 'splitmedia', divider: true, kicker: '[03] · Campaign 2: the big swing', title: 'The first Streamer Awards.',
        ...
        images: [{ src: P('azarus/azarus-streamer-awards-presenters.png'), alt: 'Presenters on stage at The Streamer Awards' }],
        body: [
      ...
      { type: 'splitmedia', divider: true, kicker: '[04] · Campaign 3: running it back', title: 'Streamer Royale: same engine, different stage.',
        ...
        images: [{ src: P('azarus/azarus-streamer-royale-lineup.jpg'), alt: 'Streamer Royale key art: headshots of eighteen streamers arranged around the Streamer Royale logo' }],
      ...
      { type: 'splitmedia', divider: true, kicker: '[05] · In parallel', title: 'A cross-platform launch with Meta.',
        ...
        images: [{ src: P('azarus/azarus-facebook-gaming-beta-lockup.png'), alt: 'Azarus and Facebook Gaming beta partnership lockup' }],
  ...
  /* ── 04 · AZARUS · ADS ── */
  {
    ...
    blocks: [
      ...
      { type: 'band', contain: true, narrow: true, src: P('azarus/azarus-go-live-trivia.jpeg'), alt: 'Azarus in-stream trivia running live over a game broadcast',
  ...
  /* ── 05 · SIEGE CHAMPIONS ── */
  {
    ...
    blocks: [
      ...
      { type: 'band', contain: true, src: P('ubisoft-siege/rainbow-six-siege-key-art.jpg'), alt: 'Tom Clancy\'s Rainbow Six Siege key art',
      ...
      { type: 'band', contain: true, src: P('ubisoft-siege/ubisoft-siege-champions-program-banner.png'), alt: 'Siege Champions Program key art: two operators in program skins with the programme logo on a coloured-spray backdrop',
      ...
      { type: 'splitmedia', divider: true, mediaWide: true, vcenter: true,
        ...
        images: [{ src: P('ubisoft-siege/ubisoft-siege-champions-reddit-post-full.png'), alt: 'The Siege Champions Program announcement post on Reddit' }],
  ...
  /* ── 06 · DELTA COMPANY ── */
  {
    ...
    blocks: [
      ...
      { type: 'band', src: P('ubisoft-delta/02-ghost-recon-keyart.jpg'), alt: 'Tom Clancy\'s Ghost Recon Breakpoint key art',
      ...
      { type: 'splitmedia', invert: true, mediaWide: true, tightBottom: true,
        ...
        images: [
          ...
          { src: P('ubisoft-delta/04-brand-variations.png'), alt: 'Delta Company identity variations: the wordmark, two roundel badges and the delta monogram, in white on black and black on white' },
          { src: P('ubisoft-delta/03-five-clusters.png'), alt: 'The five Delta Company detachment badges: Company Comms, Special Activities, Mission Intel, Team Operations and Tactical Assault' },
        ],
  ...
  /* ── 07 · BLABLACAR ── */
  {
    ...
    blocks: [
      ...
      { type: 'band', contain: true, src: P('blablacar/blablacar-logo-blue.png'), alt: 'BlaBlaCar logo in blue' },
      ...
      { type: 'carousel', contain: true, caption: 'The Live Nation partnership on the ground: the BlaBla Tent, priority parking, and the fans who turned up for it, across Latitude, Leeds and Reading.', items: [
        { src: P('blablacar/blablacar-tent.png'), alt: 'BlaBlaCar community tent at a UK festival' },
        { src: P('blablacar/laura-tent-team-police.jpg') },
        { src: P('blablacar/blablacar-priority-parking.jpeg') },
        { src: P('blablacar/blablacar-tweet-reading.png'), alt: 'BlaBlaCar festival tweet at Reading' },
        { src: P('blablacar/blablacar-ticket-winner.jpeg'), alt: 'A BlaBlaCar festival ticket competition winner' },
      ] },
      ...
      { type: 'carousel', contain: true, caption: 'Laughing, singing, the view out the window: real carpool moments, not a polished ad.', items: [
        ...
        { src: P('blablacar/blablacar-coffee-quote.jpg'), alt: 'BlaBlaCar social post pairing a carpool quote with a coffee shot' },
        { src: P('blablacar/blablacar-group-selfie.jpg'), alt: 'Four carpoolers smiling in a car together, photographed from the passenger seat' },
        { src: P('blablacar/blablacar-countdown-post.jpg'), alt: 'BlaBlaCar festival countdown social post' },
