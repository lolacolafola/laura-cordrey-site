...
//
// ORDER: grouped by client, groups ordered by strength — biggest
// name + biggest number first. Opens on Ubisoft (global brand
// recognition, the largest single number on the page: 50M+ UGC
// views at zero media spend), then Azarus (a real acquisition
// outcome, not just a metric), then US Mobile (concrete revenue,
// but a less globally recognized name), closes on BlaBlaCar (a
// big name too, but its lead metric — CAC — needs more context to
...
const caseStudies = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: 'case-studies/blablacar/blablacar-ride-board-closeup.png', alt: 'BlaBlaCar ride board close-up at a festival', caption: 'The ride board: carpooling made visible and social.' },
      { src: 'case-studies/blablacar/blablacar-tent.png', alt: 'BlaBlaCar community tent at a UK festival', caption: 'The community tent across Latitude, Leeds and Reading.' },
      { src: 'case-studies/blablacar/blablacar-priority-parking.jpeg', alt: 'BlaBlaCar priority parking at the festival entrance', caption: 'Priority parking: carpool to the festival, park at the entrance.' },
      { src: 'case-studies/blablacar/laura-tent-team-police.jpg', alt: 'Laura Cordrey with the BlaBlaCar festival team', caption: 'On the ground with the festival team.' },
    ],
    media: {
